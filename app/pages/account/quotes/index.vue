    ...
    <div class="bg-card shadow-sm">
      <ClientOnly>
        <OrderList
          ...
          :onOrderClick="(id: number) => router.push(localizeHref(`/account/quotes/${id}`, languageStore.language))"
          :orderStatus="['QUOTATION']"
          :labels="labels"
          :rowsClickable="true"
          :searchFields="['term', 'createdAt', 'price']"
          :columnConfig="{ id: '#', date: 'Date', status: 'Status', validUntil: 'Valid until', total: 'Total' }"
