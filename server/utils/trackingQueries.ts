...
export const TRACKER_MAX_LIMIT = 100;
export const TRACKER_MAX_RANGE_DAYS = 400;
...
export const TRACKER_METRICS: Record<string, Runner> = {
  /**
...
export const TRACKER_METRIC_NAMES = Object.keys(TRACKER_METRICS);
